    ...
    <div className="row">
      <div className="left col-xs-12 col-sm-12 col-md-8 col-lg-8">
        <p className="text-title">
          <span className="text-title1">Trang chủ - </span>
          <span className="text-title2">Sự kiện</span>
        </p>
        <hr className="hr1" />
        <span className="mon">MON |</span>
        <span className="day"> 02.07.2020</span>{" "}
        ...
        <div className="title row">
          <img
            className="col-md-2"
            style={{ marginTop: 10, height: 35, width: 60 }}
            src={img.imgarraw}
          />
          <h4 className="col-md-8" style={{ display: "inline-block" }}>
      ...
      <div
        className="col-xs-12 col-sm-12 col-md-4 col-lg-4 p-0"
        style={{ paddingTop: "65px !important" }}
      >
        <div className="right" style={{ width: 319, marginLeft: "auto" }}>
          <div className="bar position-relative">
            ...
            <span>
              ...
              <img
                className="img"
                style={{ marginLeft: 27, width: 25, height: 25 }}
                src={img.imggray}
              />
            </span>
          </div>
            ...
            <div className="row row-boder-bottom m-0">
              ...
              <div className="col-md-8 width-responsive p-0">
                ...
                <p className="card-text">
                  ...
                  <img
                    className="img"
                    style={{ marginLeft: 55, width: 25, height: 25 }}
                    src="./images/page9/buttom-red.png"
                  />
                </p>
              </div>
            </div>
          ...
          <div style={{ marginTop: 20 }}>
            <iframe
              src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fgsotgroup&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId"
              width={319}
              height={700}
