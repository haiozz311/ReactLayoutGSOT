      ...
      <div className="page5">
        ...
        <section className="VIETDATA ">
          <div className="conten">
              ...
              <p className="text mb-0 mt-0" style={{paddingBottom:"20px"}}>
              ...
              >
                ...
                <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6  ">
                  ...
                  <img className="img-circle " src={img.body4} alt />
                  </div>
                  </div>
                </div>
              </div>
